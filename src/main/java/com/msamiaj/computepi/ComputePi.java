...
/**
 * Computes Pi by summing a Circle's area.
 */
public class ComputePi implements Serializable {
    ...
    private void start(int slices) {
        int numberOfThrows = 10_0000 * slices;
        ...
        System.out.println("********* Showing throws *********");
        ...
        System.out.println("********* Showing mapped throws *********");
        dartsDs.show(5);
